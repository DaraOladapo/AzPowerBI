...
namespace AzCostPowerBI.Common
{
    public class AzureCostManagement : IAzureCostManagement
    {
        ...
        //public async Task<List<CostManagementResponse>> GetCostManagementData(ILogger log, string subscriptionId, int startDate, int endDate)
        //{
        //    _subscriptionId = subscriptionId;
        //    var invoiceDayFrom = startDate;
        //    var invoiceDayTo = endDate;
        ...
        //            webResponse = await httpResponse.Content.ReadAsStringAsync();
        //        }
        //        // Get the response
